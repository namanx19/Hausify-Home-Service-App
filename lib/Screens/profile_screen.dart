...
class ProfileScreen extends StatelessWidget {
  ...
  void _handleLogout(BuildContext context) async {
    try {
      ...
      // After a successful logout, you can navigate to the login screen or another appropriate location.
      Navigator.pushNamed(context, '/loginScreen'); // Replace '/loginScreen' with the actual route to your login screen.
    } catch (e) {
